...
|[Рынок заведений общественного питания Москвы](catering-establishment-of-moscow)|Исследование рынка заведений общественного питания москвы, красивые визуализации, рекомендации по открытию кофейни инвестороам| ppandas matplotlib.pyplot seaborn plotly.express json folium
