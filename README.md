...
|[Рынок заведений общественного питания Москвы](AB-test)|Исследование рынка заведений общественного питания москвы, красивые визуализацию, рекомендации по открытию кофейни инвестороам| ppandas matplotlib.pyplot seaborn plotly.express json folium
